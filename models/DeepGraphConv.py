...
if __name__ == '__main__':
    x = torch.load('/data115_2/jsh/LEOPARD_GCN/Leopard_1024/CTrans/pt_files/case_radboud_0000.pt')
    model = DeepGraphConv(input_dim=768)
    hazards, S, Y_hat, A_path, _ = model(wsi=x)
    print(hazards.shape)